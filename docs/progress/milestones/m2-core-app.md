...
| — | M2-03 | Exercises tab — list grouped by 6 categories (`body, breath, voice, mind, senses, somatic`), detail screen with steps + duration | TODO | — | Category taxonomy finalised in M1-07. |
